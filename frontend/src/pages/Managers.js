      ...
      const data = filteredManagers.map((manager) => {
        ...
        try {
          formattedDate = manager.jobStartDate
            ? new Date(manager.jobStartDate).toLocaleDateString("en-US", {
                year: "numeric",
                month: "short",
                day: "numeric",
              })
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-lg font-medium text-gray-700">Loading managers...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Managers</h1>
                    ...
                    >
                      {editingId === manager._id ? (
                        ...
                        <>
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-700">{manager.age || "N/A"}</div>
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-700">
                              {manager.jobStartDate
